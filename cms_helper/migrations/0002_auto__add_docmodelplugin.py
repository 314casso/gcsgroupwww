...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocModelPlugin'
        db.create_table('cmsplugin_docmodelplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('doc_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rdoc.DocCategory'])),
        ))
        db.send_create_signal('cms_helper', ['DocModelPlugin'])


    def backwards(self, orm):
        # Deleting model 'DocModelPlugin'
        db.delete_table('cmsplugin_docmodelplugin')
