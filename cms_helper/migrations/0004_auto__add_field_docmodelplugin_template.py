...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocModelPlugin.template'
        db.add_column('cmsplugin_docmodelplugin', 'template',
                      self.gf('django.db.models.fields.CharField')(default='docplugin/doclist.html', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocModelPlugin.template'
        db.delete_column('cmsplugin_docmodelplugin', 'template')
