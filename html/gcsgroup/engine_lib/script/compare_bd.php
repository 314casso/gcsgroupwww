...
$select = "<select name=\"project\"><option>---------</option>".$option."</select>";
...
Выберите проект: <? echo $select;?>
	...
	<tr>
		<td >
			<input class=short name=db_name id=dbname value="knst">
		</td>
		<td align=right>
	...
	<tr>
		...
		<td  style="padding-left:30">
			<strong>db_pass</strong>
		</td>
	</tr>
	<tr>
		<td >
			<input class=short name=db_user id=dbuser value="knst">
		</td>
		<td align=right>
			<input  class=short name=db_pass id=dbpass value="e806em">
		</td>
	</tr>
	<tr>
		<td >
