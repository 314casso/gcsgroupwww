...
<td height=1 ><a href="menu.php?action=send"><img alt='Рассылки' src='img/zakladki/zakladka_06.jpg ' border=0></a></td>
...
"></td></table></td>
                        ...
                        <td  align=left  >
                                ...
                                <a href='#' class=link onclick='{
                                                ...
                                                proc.document.location="proc.php?action=newsend";
                        ...
                        <td align=left >
                                ...
                                <a href='#' class=link onclick='{
                                        ...
                                        if (n!=-1)         {
                                                ...
                                                proc.document.location="proc.php?action=delsend&id="+n;
...
$sql="select * from engine_send order by name";
...
while($f=mysql_fetch_array($r)){
        ...
        echo "
                ...
                <tr bgcolor='#FFFFFF'>
                        ...
                        <td width=25><img border=0 src='images/menu/send.gif'></td>
