      ...
      <tr>
        <td valign="top">
          <table>
            ...
            <tr><td>Текушая картинка: {NEW_HTTP_PIC1}</td></tr>
            <tr>
            ...
            <tr><td>Текушая картинка: {NEW_HTTP_PIC2}</td></tr>
            <tr>
        ...
        <td width="100%" valign="top">
          <table>
            <tr>
            	<td><span class="cat"><img src="img/arrow.gif" border="0" vspace="2"> Дата</span><br/>
            		<input type="text" name="ndate" class="com_input" size="20" value="{NEW_DATE}">
            	</td>
            	<td><span class="cat"><img src="img/arrow.gif" border="0" vspace="2"> Дата начала</span><br/>
            		<input type="text" name="new_date_start" class="com_input" size="20" value="{NEW_DATE_START}">
            	</td>
            	<td><span class="cat"><img src="img/arrow.gif" border="0" vspace="2"> Дата окончания</span><br/>
...
<tr>
  <td>
    ...
    <table width="90%">
      <tr>
        <td valign="top">{NEW_HTML}
          <!--<textarea style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; FONT-SIZE: 10px; BORDER-LEFT: #000000 1px solid; COLOR: #000000; BORDER-BOTTOM: #000000 1px solid; FONT-FAMILY: Varnada"  name=html rows=7 cols=100></textarea>
          <script language=JavaScript>
          if (isMSIE5 || isOpera7)
          {
