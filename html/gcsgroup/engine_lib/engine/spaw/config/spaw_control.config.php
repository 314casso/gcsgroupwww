...
//echo $spaw_root;
//$spaw_root = '/var/www/html/gcsgroup/engine_lib/engine/spaw/';
...
$spaw_dir = '/engine_lib/engine/spaw/';
...
$spaw_dropdown_data['style']['floatleft'] = 'Обтекание слева';
$spaw_dropdown_data['style']['textdoc'] = 'Текстовый документ';
$spaw_dropdown_data['style']['default'] = 'Без стиля';
...
$spaw_imglibs = array(
  array(
    'value'   => 'engine/doc_images/',
    'text'    => 'Основная галерея',
  ),
  /*
  array(
