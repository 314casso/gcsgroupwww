...
<table cellspacing="0" cellpadding="0" border="0" style="margin-top: 8px;">
  <tr>
    ...
    <td>
      <table cellspacing="1" cellpadding="3" border="0" class="table_bookmark">
        <tr><td class="td_bookmark_off" align="center" id="td_html">&nbsp;<a href="javascript:ShowTable('html');" class="doc_menu">HTML</a>&nbsp;</td></tr>
      </table>
    </td>
    <td>
      <table cellspacing="1" cellpadding="3" border="0" class="table_bookmark">
...
<table cellspacing="1" cellpadding="3" border="0" width="100%" class="line" style="margin-top: 10px; display: none;" id="table_doc">
  ...
  <tr><td><textarea name="caption_short" style="width: 350px;" rows="3">{DOC_CAPT_S}</textarea></td></tr>

  <tr><td><span class="cat"><img src="img/arrow.gif" brder="0" vspace="2"> Заголовок средний</span></td></tr>
  <tr><td><textarea name="caption_medium" style="width: 350px;" rows="3">{DOC_CAPT_M}</textarea></td></tr>

  <tr><td><span class="cat"><img src="img/arrow.gif" brder="0" vspace="2"> Заголовок длинный</span></td></tr>
  <tr><td><textarea name="caption_long" style="width: 350px;" rows="3">{DOC_CAPT_L}</textarea></td></tr>

  <tr><td><span class="cat"><img src="img/arrow.gif" brder="0" vspace="2">Резюме</span></td></tr>
  <tr><td><textarea name="resume" style="width: 350px;" rows="3">{DOC_RESUME}</textarea></td></tr>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%" class="line" style="margin-top: 10px; display: none;" id="table_html">
  ...
  <tr><td><textarea name="meta" style="width: 350px;" rows="3">{DOC_META}</textarea></td></tr>

  <tr><td><span class="cat"><img src="img/arrow.gif" brder="0" vspace="2"> Title</span></td></tr>
  <tr><td><input class="com_input" name="title" value="{DOC_TITLE}" style="width: 350px;"></td></tr>
  ...
  <tr><td><textarea name="counter1" style="width: 350px;" rows="3">{DOC_COUNTER1}</textarea></td></tr>

  <tr><td><span class="cat"><img src="img/arrow.gif" brder="0" vspace="2"> Счетчик №2</span></td></tr>
  <tr><td><textarea name="counter2" style="width: 350px;" rows="3">{DOC_COUNTER2}</textarea></td></tr>

  <tr><td><span class="cat"><img src="img/arrow.gif" brder="0" vspace="2"> Счетчик №3</span></td></tr>
  <tr><td><textarea name="counter3" style="width: 350px;" rows="3">{DOC_COUNTER3}</textarea></td></tr>
</table>
