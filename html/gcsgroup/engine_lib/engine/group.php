    ...
    <table cellpadding="3" cellspacing="1" border="0" style="margin-top: 5px;" class="line_blue" width="100%">
      <tr>
        <td class="td_blue2">
          <table cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td width="36" align="center"><a href="#" onclick="javascript: CreateGrp();"><img src="img/act_2.gif" alt="Создать документ" border="0"></a></td>
              <td width="36" align="center"><a href="#" onclick="javascript: DeleteGrp()"><img src="img/act_4.gif" alt="Удалить" border="0"></a></td>
            </tr>
          </table>
        </td>
      </tr>
  ...
  <tr><td height="100%">
    <table cellpadding="0" cellspacing="0" border="0" class="line_blue" width="100%" height="100%">
      <tr>
        ...
        ?>
          <tr><td><img src="img/doc_root.gif" border="0"></td><td colspan="2" width="100%" class="tree_td"><span class="tree">Группы (<?=$size;?>)</span></td></tr>
        <?
