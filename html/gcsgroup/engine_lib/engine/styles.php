...
<td height=1 ><a href="menu.php?action=style"><img alt='Стили' src='img/zakladki/zakladka_05.jpg ' border=0></a></td>
<?}?>
...
"></td></table></td>
                        <td  align=left  >
                                <a href='#' class=link onclick='{
                                                proc.document.location="proc.php?action=new<?=$action?>&pid="+n;
                                        }'><img class=ibutton onMouseOver='mo(this)' onMouseleave='ml(this)' src='img/big_txt.jpg'  border=0 alt='СОЗДАТЬ СТИЛЬ'></a>
                        </td>
                        <td align=left >

                                <a href='#' class=link onclick='{
                                        if (n!=-1)         {
                                                proc.document.location="proc.php?action=del<?=$action?>&id="+n;
                                                }
                                        }'><img class=ibutton onMouseOver='mo(this)' onMouseleave='ml(this)'  src='img/big_del.jpg' border=0 alt='УДАЛИТЬ СТИЛЬ'></a>
                        </td>
...
<?
$sql="select * from engine_styles order by name";
                ...
                <tr bgcolor='#FFFFFF'>
                        ...
                        <td class=top align=center>
                                <a class=menu id=a$f[id] href='#'
                                        onclick='{
                                                swtch(".$f[id].");
                                                }'><!-- <img border=0 id=img$f[id] src='img/style.gif'> -->".$f[name]."</a>
                        </td>
                </tr>
                ";
        }
