...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contactlist_partner', (
        ...
        db.send_create_signal('contactlist', ['Partner'])

        # Adding field 'Contact.published'
        db.add_column('contactlist_contact', 'published',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('contactlist_partner')

        # Deleting field 'Contact.published'
        db.delete_column('contactlist_contact', 'published')
