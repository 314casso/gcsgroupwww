...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('contactlist_partner', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Partner.description_zh_cn'
        db.alter_column('contactlist_partner', 'description_zh_cn', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partner.description_en'
        db.alter_column('contactlist_partner', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Partner.description_ru'
        db.alter_column('contactlist_partner', 'description_ru', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Partner.description'
        db.alter_column('contactlist_partner', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Partner.description_zh_cn'
        db.alter_column('contactlist_partner', 'description_zh_cn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Partner.description_en'
        db.alter_column('contactlist_partner', 'description_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Partner.description_ru'
        db.alter_column('contactlist_partner', 'description_ru', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
