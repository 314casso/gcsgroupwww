...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.title_ru'
        db.add_column('contactlist_partner', 'title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.title_en'
        db.add_column('contactlist_partner', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.title_zh_cn'
        db.add_column('contactlist_partner', 'title_zh_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.description_ru'
        db.add_column('contactlist_partner', 'description_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.description_en'
        db.add_column('contactlist_partner', 'description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Partner.description_zh_cn'
        db.add_column('contactlist_partner', 'description_zh_cn',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.title_ru'
        db.delete_column('contactlist_partner', 'title_ru')

        # Deleting field 'Partner.title_en'
        db.delete_column('contactlist_partner', 'title_en')

        # Deleting field 'Partner.title_zh_cn'
        db.delete_column('contactlist_partner', 'title_zh_cn')

        # Deleting field 'Partner.description_ru'
        db.delete_column('contactlist_partner', 'description_ru')

        # Deleting field 'Partner.description_en'
        db.delete_column('contactlist_partner', 'description_en')

        # Deleting field 'Partner.description_zh_cn'
        db.delete_column('contactlist_partner', 'description_zh_cn')
    ...
    models = {
        ...
        'contactlist.partner': {
            ...
            'title_zh_cn': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
