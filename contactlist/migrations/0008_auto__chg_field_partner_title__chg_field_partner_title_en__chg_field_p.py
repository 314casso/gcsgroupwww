...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partner.title'
        db.alter_column('contactlist_partner', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Partner.title_en'
        db.alter_column('contactlist_partner', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Partner.title_ru'
        db.alter_column('contactlist_partner', 'title_ru', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'Partner.title_zh_cn'
        db.alter_column('contactlist_partner', 'title_zh_cn', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Partner.title'
        db.alter_column('contactlist_partner', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Partner.title_en'
        db.alter_column('contactlist_partner', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Partner.title_ru'
        db.alter_column('contactlist_partner', 'title_ru', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Partner.title_zh_cn'
        db.alter_column('contactlist_partner', 'title_zh_cn', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'contactlist.partner': {
            ...
            'description_zh_cn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'title_zh_cn': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
