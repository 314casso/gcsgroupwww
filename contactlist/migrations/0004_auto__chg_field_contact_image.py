...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('contactlist_contact', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Contact.image'
        raise RuntimeError("Cannot reverse this migration. 'Contact.image' and its values cannot be restored.")
